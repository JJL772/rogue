...
class Col:
    ...
    ColumnWidths = [ 300,    50,     75,     75,                 400,     75]
...
class DebugTree(PyDMFrame):
    ...
    def _expandCb(self,item):
        self.setUpdatesEnabled(False)
        item._expand()
        self._tree.setColumnWidth(Col.Node, Col.ColumnWidths[Col.Node])
        self._tree.setColumnWidth(Col.Offset, Col.ColumnWidths[Col.Offset])
